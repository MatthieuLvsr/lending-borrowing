...
import { NewPoolButton } from '@/components/new-pool-button';
import {
  Card,
  CardContent,
  CardDescription,
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <h1 className="font-bold text-3xl">Marchés</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-sm">$245.8M</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-sm">8,450</span>
                </div>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-sm">$178.3M</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">APY moyen d emprunt</span>
                  <span className="font-medium text-sm">5.6%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Ratio d utilisation moyen</span>
                  <span className="font-medium text-sm">72.5%</span>
                </div>
              </div>
            </div>
          </CardContent>
