          ...
          <div className="overflow-hidden rounded-lg border bg-background p-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-bold text-xl">Simulateur de Prêt</h3>
                <p className="text-muted-foreground text-sm">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-sm">10,000 USDC</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-sm">12 mois</span>
                      </div>
                    </div>
