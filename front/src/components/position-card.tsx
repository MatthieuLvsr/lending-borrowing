    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex justify-between">
            <p className="text-xs text-muted-foreground">{isBorrow ? "Taux d'Emprunt (APY)" : "Taux de Prêt (APY)"}</p>
            <p className={`text-sm font-medium ${isBorrow ? "text-primary" : "text-green-500"}`}>{apy}</p>
          </div>
        </div>
      </CardContent>
